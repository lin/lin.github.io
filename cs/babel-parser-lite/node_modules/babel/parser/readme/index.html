...
<meta itemprop="description" content="@babel/parser  A JavaScript parser
...
<meta property="og:description" content="@babel/parser  A JavaScript parser
 See our website @babel/parser for more information or the issues associated with this package.
Install Using npm:
npm install --save-dev @babel/parser or using yarn:
yarn add @babel/parser --dev " />
<meta property="og:type" content="article" />
<meta property="og:url" content="https://yingkui.com/cs/babel-parser-lite/node_modules/babel/parser/readme/" /><meta property="article:section" content="cs" />
...
<p>Using npm:</p>
<div class="highlight"><pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4"><code class="language-sh" data-lang="sh">npm install --save-dev @babel/parser
</code></pre></div><p>or using yarn:</p>
<div class="highlight"><pre tabindex="0" style="color:#f8f8f2;background-color:#272822;-moz-tab-size:4;-o-tab-size:4;tab-size:4"><code class="language-sh" data-lang="sh">yarn add @babel/parser --dev
</code></pre></div>
			</div>
